...
public abstract class ResultParser {
  ...
  private static final ResultParser[] PARSERS = {
      ...
      new PubTransResultParser(), // Aufnahme des neuen Parsers zum parsen des Pubtransit QR-Codes
  };
  ...
  public static ParsedResult parseResult(Result theResult) {
    for (ResultParser parser : PARSERS) {
    	...
    	Log.d("ResultParser.java", "ParsedResult: " + parser.toString());
    	
    	ParsedResult result = parser.parse(theResult);
      
    	// Jedem Parser wird der Inhalt eines gescannten QR-Codes übergeben. Wenn ein Parser etwas mit dem
    	// Inhalt anfangen kann, wird die Bedingung im if-Teil erfüllt
      if (result != null) {
    	  Log.d("ResultParser.java", "ParsedResult: " + parser.toString());
        return result;
      }
